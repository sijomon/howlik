	...
	<div class="container">
		<div class="row"> 
			...
			<div class="col-sm-9 page-content">
				<div class="inner-box">
					<h2 class="title-2"><i class="icon-docs"></i> @lang('global.Bookings on') {{ $event->event_name }} 
						<a href="{{ lurl('account/myevents') }}" style="float:right;" class="btn btn-default btn-xs"> @lang('global.Go Back') </a>
					</h2>
					<div class="table-responsive">
						<div id="b-book-div">
							@include('classified.home.inc.event-booking-ajax')
						</div>
					</div>
				</div>
			</div>
