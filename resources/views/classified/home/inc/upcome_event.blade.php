			...
			<a href="{{ lurl('/preview/event/'.$events->id) }}">
				<div class="hovereffect"> 
					@if($events->event_image1 != '')
						<img class="responsive" src="{{ url($events->event_image1) }}" pagespeed_url_hash="2541112653" onload="pagespeed.CriticalImages.checkImageForCriticality(this);" alt=""/>
					@else
						<img class="responsive" src="{{ url('/uploads/pictures/no-image.jpg') }}" pagespeed_url_hash="2541112653" onload="pagespeed.CriticalImages.checkImageForCriticality(this);" alt=""/>
					@endif
					<div class="overlay">
...
<!-- BOF PAGINATION LINK -->
<div class="col-md-12 pagination-bar text-center" id="upcoming">
	{!! $all_events->appends(Request::except('page'))->render() !!}
</div>
<!-- EOF PAGINATION LINK -->