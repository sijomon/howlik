...
<!-- //for-mobile-apps -->
<link rel="stylesheet" href="{{ url('/assets/frontend/css/paypal1.style.css') }}" type="text/css" />
...
<body>
	<div class="main">
		<div class="content">
			<script src="{{ url('/assets/frontend/js/easyResponsiveTabs.js') }} " type="text/javascript"></script>
				...
				<div id="horizontalTab" style="display: block; width: 100%; margin: 0px;">
					...
					<div class="resp-tabs-container">
						...
						<div class="" aria-labelledby="tab_item-2">
							...
							</div>sreeharis@shrishtionline.com
						</div>-->
						<br>
						<div class="" aria-labelledby="tab_item-3">	
							<div class="payment-info">
								<h3>Personal Information</h3>
								<form method="post" action="{{ url('tests/payment_process.php?action=process') }}">
								{!! csrf_field() !!}
									<div class="tab-for">				
										<h5>EMAIL ADDRESS</h5>
