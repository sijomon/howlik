				...
				<div class="col-md-8 col-sm-8">
					<div class="detail-row">
						<div class="company-name">
							...
							@else
								@if (!auth()->user())
									<a class="claim-btn" href="{{ lurl(trans('routes.login')) }}"> {{ t('Claim this business')}} </a>
								@else
						...
						@if(isset($endTm) && $endTm!='')
							...
							@if($bizhrsflag)
								...
								@if( isset($timeStrt[2]))
									...
									@if (($timeNoww > $start0 && $timeNoww < $end0) || ($timeNoww > $start1 && $timeNoww < $end1) || ($timeNoww > $start2 && $timeNoww < $end2) )
										<font color="green">  
											{{ t('Open') }} 
										</font>
									@else
								...
								@elseif( isset($timeStrt[1]))
									...
									@if (($timeNoww > $start0 && $timeNoww < $end0) || ($timeNoww > $start1 && $timeNoww < $end1))
										<font color="green">  
											{{ t('Open') }} 
										</font>
									@else
								...
								@elseif( isset($timeStrt[0]))
									...
									@if($start0 > $end0)
										...
										{{--*/ $midNight2 = '00:00 am'; /*--}}
											...
											@if(($timeNoww > $start0 && $timeNoww < $midNight1) || ($timeNoww > $midNight2 && $timeNoww < $end0))
												<font color="green">  
													{{ t('Open') }} 
												</font>
											@else
											...
											@endif
									@else
											@if($timeNoww > $start0 && $timeNoww < $end0)
												<font color="green">  
													{{ t('Open') }} 
												</font>
											@else
							...
							<table class="table" style=" margin-top: 10px; margin-left: 5px; margin-bottom: 10px; ">
								...
								@if($bizhrsflag)
									@foreach($bizhrs as $key => $value)
										...
										<tr>
											@if($dayRepeat != $bizDayA[$bizhrsA[0]])
												<td style="text-align: left;" width="10%"> {{ $bizDayA[$bizhrsA[0]]}} </td>
											@else
