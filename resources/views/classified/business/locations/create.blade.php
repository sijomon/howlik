			...
			<div class="row">
				...
				<div class="col-md-9 page-content">
					<div class="inner-box category-content">
						...
						<h2 class="title-2"><strong> <i class="icon-docs"></i> {{ t('Add a New Location For') }} @if(isset($business)) @if(Request::segment(1) == 'ar') {{ $business->title_ar }} @else {{ $business->title }} @endif @endif</strong></h2>
						<div class="row">
							<div class="col-sm-12">
								<form class="form-horizontal" id="create-location" method="POST" action="{{ lurl('account/business/location/create') }}">
									{!! csrf_field() !!}
									...
									<fieldset>
										...
										<div class="form-group required <?php echo ($errors->has('phone')) ? 'has-error' : ''; ?>">
											...
											<div class="col-md-8">
												...
												<input id="phone" name="phone"  placeholder="{{ t('Phone Number (in local format)') }}" class="form-control" type="text" value="{{ old('phone') }}" />
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-md-8">
												<div style="display: none;">
													...
													<input id="lat1" name="lat1" style="width:50%;" class="form-control input-md" value="12.9833" readonly />
													<label class="control-label" for="lon1"> {{ t('Long') }}</label>
													<input id="lon1" name="lon1" style="width:50%;" class="form-control input-md" value="77.5833" readonly />
													<br />
												</div>
										...
										<div class="form-group">
											...
											<div class="col-md-8">
												<a href="{{ lurl('account/business/location/'.$business->id) }}" class="btn btn-default btn-md"> @lang('global.Cancel') </a>
