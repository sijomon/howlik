		...
		<div class="user-panel-sidebar">
			...
			<div class="collapse-box">
				<h5 class="collapse-title">
					...
					<a href="#MyEvents" data-toggle="collapse" class="pull-right"><i class="fa fa-angle-down"></i></a>
				</h5>
            ...
            <div class="collapse-box">
				<h5 class="collapse-title">
					@lang('global.My Business Listings')&nbsp;
				...
				<div class="panel-collapse collapse in" id="MyBiz">
					<ul class="acc-list">
						<li>
							<a{!! (Request::segment(3)=='mybusinesslistings') ? ' class="active"' : '' !!} href="{{ lurl('account/mybusinesslistings') }}">
							<i class="icon-docs"></i> @lang('global.Business List')&nbsp;
							<span class="badge">{{ isset($count_my_business) ? $count_my_business : 0 }}</span>
							</a>
						</li>
						<li>
							...
							<span class="badge">{{ isset($count_pending_business) ? $count_pending_business : 0 }}</span>
							</a>
						</li>
						<li>
							<a{!! (Request::segment(4)=='graph') ? ' class="active"' : '' !!} href="{{ lurl('account/business/graph') }}">
							<i class="icon-cancel-circled "></i> @lang('global.Business Activity Graph')
							</a>
						</li>
					</ul>
				</div>
