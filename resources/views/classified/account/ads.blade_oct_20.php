	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<!--<form role="form" method="POST" action="">-->
              ...
              ?>
              <div class="single_review" id="single_review_<?= $h ?>"  style="display:none;">
                @foreach ($reviews_for_this_ad as $reviews)
								   ...
								   ?>
                                    ...
                                    <span class="date_new"><?php echo date('d/m/Y',strtotime($reviews->created_at)) ?></span>
                                    </div>
