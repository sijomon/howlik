...
<div class="main-container"> @if (Session::has('flash_notification.message'))
  ...
  <div class="container">
    <ol class="breadcrumb pull-left">
      ...
      <li> <a href="{{ url($lang->get('abbr').'/'.$country->get('icode').'/'.slugify($country->get('name')).'/'.$parent_cat->slug) }}"> {{ $parent_cat->name }} </a> </li>
      @if ($parent_cat->id != $cat->id)
      <li> <a href="{{ url($lang->get('abbr').'/'.$country->get('icode').'/'.slugify($country->get('name')).'/'.$parent_cat->slug.'/'.$cat->slug) }}"> {{ $cat->name }} </a> </li>
      @endif
      ...
      <div class="col-sm-9 page-content col-thin-right">
        <div class="inner inner-box ads-details-wrapper">
          <h2> <strong> <a href="{{ lurl(slugify($ad->title).'/'.$ad->id.'.html') }}"
										title="{{ mb_ucfirst($ad->title) }}">{{ mb_ucfirst($ad->title) }}</a> </strong> <small class="label label-default adlistingtype">{{ t(':type ad', ['type' => t(''.$ad->adType->name)]) }}</small> <span class="avarage_rating" >
          ...
          <span class="info-row"> <span class="date_holder"><i class=" icon-clock"> </i> {{ $ad->created_at_ta }} </span> -&nbsp; <span class="category">{{ $parent_cat->name }}</span> -&nbsp; <span class="item-location"><i class="fa fa-map-marker"></i> {{ $ad->city->name }} </span> -&nbsp; <span class="category"><i class="icon-eye-3"></i> {{ $ad->visits }} {{ (\Illuminate\Support\Facades\Lang::has('global.views')) ? trans_choice('global.views', $ad->visits) : '' }}</span> </span> @if (count($ad->pictures) > 0)
          <div class="ads-image">
              ...
              <div class="ads-details-info col-md-8">
                ...
                <div class="all_reviews"> @foreach ($reviews_for_this_ad as $reviews)
                  <?php $user_id = $reviews->user_id; 
										  ...
										  $user_name     =	$reviewed_user[0]->name;						
									
									      $default       = "http://www.howlik.com/assets/frontend/images/default.png";
									 ?>
                  <div class="single_review">
                    <div class="default_image"><img src="{{ $default }}" /></div>
                ...
                <div class="ads-action">
                  <ul class="list-border">
                    ...
                    <li>
                      ...
                      <a class="favorite_link" id="fav_id" onclick="save_fav(<?php echo $ad_org_id; ?>,<?php echo $logined_user; ?>);" > <i class="fa fa-heart"></i> Select Favourite </a> <a class="favorite_link" id="extra_remove_id" style="display:none;" onclick="remove_fav(<?php echo $ad_org_id; ?>,<?php echo $logined_user; ?>);" > <i class="fa fa-heart"></i> Remove Favourite</a>
                      <?php }else{ ?>
                      <a class="favorite_link" id="extra_fav_id" style="display:none;"  onclick="save_fav(<?php echo $ad_org_id; ?>,<?php echo $logined_user; ?>);" > <i class="fa fa-heart"></i> Select Favourite </a> <a class="favorite_link" id="remove_id" onclick="remove_fav(<?php echo $ad_org_id; ?>,<?php echo $logined_user; ?>);" > <i class="fa fa-heart"></i> Remove Favourite</a>
                      <?php  } ?>
                    </li>
                    <li>
                      <?php  if($reviewed_by_this_user === 0)  {    ?>
                      <a href="javascript:write_review();" id="write_review_link" > <i class="fa fa-comment"></i> Write Review </a>
                      <form id="review_form"  style="display:none;" >
                        ...
                        <span id="review_success" style="display:none;"> Reviewed Successfully</span>
                      </form>
                      <?php }else {
										 ?>
                      <a href="javascript:show_review();" id="review_link" > <i class="fa fa-comment"></i> Show Review </a> <a href="javascript:hide_review();" id="review_hide_link" style="display:none" > <i class="fa fa-comment"></i>Hide Review </a>
                        ...
                        <tbody>
                          ...
                          <tr>
                            <td valign="top"><div id="tutorial-<?php echo $ad_org_id; ?>" >
                                ...
                                <span id="rating_success" style="display:none;"> Rated Successfully</span> </div></td>
                          </tr>
                        </tbody>
                      </table>
                    </li>
