...
<div class="row">
	<div class="col-md-8 col-md-offset-2">
		<!-- Default box -->
			...
			{!! Form::open( array('route' => 'subcategorypostaddajax1', 'method' => 'POST', 'id' => 'ajax_user')) !!}
		  <div class="box">
			...
			<div class="form-group">
			 ...
			 <div class="form-group">
			   ...
			   <div class="form-group">
				<label>Picture</label>
				<input type="text" class="form-control"	id="picture-filemanager" name="picture"	label="Picture"	type="browse" value="{{$c->picture}}"readonly>
			...
			<div class="checkbox">
				<label>
				  ...
				  <input type="checkbox" name="active" label="Active" type="checkbox" <?php if ($c->active == 1) { ?>  checked="checked" <?php } ?>> Active
				</label>
			</div>
