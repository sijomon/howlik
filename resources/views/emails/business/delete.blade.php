...
@section('title', trans('mail.Your business ":title" has been deleted', ['title' => $biz->title]))
    ...
    <table style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; font-size: 100%; line-height: 1.6em; width: 100%; margin: 0; padding: 0;">
        <tr style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; font-size: 100%; line-height: 1.6em; margin: 0; padding: 0;">
            <td style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; font-size: 100%; line-height: 1.6em; margin: 0; padding: 0;">
                <p style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 1.6em; font-weight: normal; margin: 0 0 10px; padding: 0;">@lang('mail.Hello,<br><br>Your business ":title" has been deleted from :domain at :now.<br><br>Thank you for your trust and see you soon,<br><br>The :domain Team<br>:domain<br><br><br>PS: This is an automated email, please don\'t reply.',
                ['title' => mb_ucfirst($biz->title), 'now' => \Carbon\Carbon::now(session('time_zone'))->formatLocalized('%d %B %Y'), 'countryDomain' => lurl('/'), 'domain' => ucfirst(getDomain())])</p>
            </td>
        </tr>
    </table>
    </div>
