		...
		<div class="container">
			<div class="row">
				<div class="payment-result-section">
					<div class="payment-result-box payment-result-box-success"> <span class="fa fa-check status-icon"></span>
						...
						<a href="http://www.howlik.com/<?php echo $_GET[lang]; ?>/create/<?php echo $_GET[id]; ?>/certificate" role="button" class="btn btn-block btn-prb2"> Purchase Again </a>
					</div>
				</div>
			</div>
		</div>
