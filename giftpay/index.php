<?php 
	...
	$data = array (
		...
		'currency_code'	 =>	'USD',
		'thanks_page'	 =>	"http://".$_SERVER['HTTP_HOST'].'/giftpay/success.php?id='.$biz_id.'&lang='.$lan_id,
		'notify_url'	 =>	"http://".$_SERVER['HTTP_HOST'].'/giftpay/ipn.php?id='.$pay_id,
		'cancel_url'	 =>	"http://".$_SERVER['HTTP_HOST'].'/giftpay/cancel.php?id='.$biz_id.'&lang='.$lan_id,
		'test_mode'		 =>	$test_mode,
	);	
