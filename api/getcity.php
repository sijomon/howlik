...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<form method="post" align="center" action="http://www.howlik.com/api/events/upcome" id="form">
			...
			<input type="text" name="apikey" id="apikey" placeholder="API KEY" value="920351517377979" required />
			<div>
				<br>
			</div>
			...
			<input type="text" name="location_code" id="location_code" value="IN.16" placeholder="LOCATION CODE" />
			<div>
				<br>
			</div>
...
<script>
	function get() {
		$.ajax({
			...
			dataType: 'json',
			data: { 'apikey' : $('#apikey').val(), 'country_code' : $('#country_code').val(), 'location_code' : $('#location_code').val() },
