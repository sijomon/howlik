...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<form method="post" align="center" action="http://www.howlik.com/api/dashboard" id="form">
			...
			<input type="text" name="apikey" id="apikey" placeholder="API KEY" value="707351522319778" required />
			<div>
				<br>
			</div>
			<input type="text" name="msg_id" id="msg_id" placeholder="MESSAGE ID" value="" required />
			<div>
				<br>
			</div>
...
<script>
	function get() {
		...
		$.ajax({
			url: 'http://www.howlik.com/api/messages/list',
			type: 'GET',
			dataType:'json',
			data: { 'apikey' : $('#apikey').val(), 'msg_id' : $('#msg_id').val() },
