...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<form method="post" align="center" action="http://www.howlik.com/api/create/business/load" id="form">
			<h3>Business Create GET</h3> <br>
			</div>
			<input type="text" name="apikey" id="apikey" placeholder="API KEY" value="920351517377979" autocomplete="on" />
			<div>
				<br>
			</div>
		...
		<form method="post" align="center" action="http://www.howlik.com/api/create/business" enctype="multipart/form-data" id="form">
...
<script>
	...
	function get() {
		...
		$.ajax({
			url: 'http://www.howlik.com/api/create/business/load',
			type: 'GET',
			headers: {
