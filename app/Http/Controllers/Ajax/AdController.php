...
use App\Larapen\Models\Review_reply;
...
class AdController extends FrontController
{
	...
	public function set_reviews()
	{
	 ...
	 public function set_reply_for_reviews()
    {
		...
		$review_id     = $_POST["review_id"];
			...
			$replayed_by_vendor = DB::table("review_reply")
			    ->select('review_id')
				->where("review_id",  "=", $review_id) 
				->get();
			
			if(!empty($replayed_by_vendor))	
				{
					//already added
