...
class BusinessBookingOrder extends BaseModel
{
    /**
     ...
     * @var string
     */
    protected $table = 'businessBookingOrder';
    ...
    protected $fillable = ['settings_id', 'biz_loc', 'user_id', 'extraInfo', 'name', 'email', 'mobile', 'notes', 'approved'];
