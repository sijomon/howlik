...
class BusinessImageRequest extends BaseModel
{
    /**
     ...
     * @var string
     */
    protected $table = 'businessImageRequests';
     ...
     * @var array
     */
    protected $fillable = ['biz_id', 'filename', 'posted_by', 'active'];
    ...
    */
    ...
    {
        return $this->belongsTo('App\Larapen\Models\User', 'posted_by');
    }
